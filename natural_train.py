...
def epoch_train(args, model, device, train_loader, test_loader, optimizer, scheduler):
    epochs = args.epochs
    best_epoch = 0
    best_acc = 0
...
def main():
    ...
    create_loss_txt_path = os.path.join(args.log_path, create_loss_txt_filename)
